 ...
 * @since 2018-11-16
 */
public class CsUcUser implements Serializable {
    ...
    public String toString() {
        ...
        ", fdSyncsys=" + fdSyncsys +
        ", fdOrder=" + fdOrder +
        ", fdUsertype=" + fdUsertype +
        ", fdPosition=" + fdPosition +
        ", fdPositionLevel=" + fdPositionLevel +
        ", fdTel=" + fdTel +
        ...
        ", fdOrgId=" + fdOrgId +
        ", fdOrgName=" + fdOrgName +
        ", fdEntryTime=" + fdEntryTime +
        ", fdQuitTime=" + fdQuitTime +
        ", fdAutoStopTime=" + fdAutoStopTime +
        ", fdIsdelete=" + fdIsdelete +
        ", fdGender=" + fdGender +
        ", fdUpdateSign=" + fdUpdateSign +
        ", fdTahoeMessageSid=" + fdTahoeMessageSid +
        ", fdTopPhotoUrl=" + fdTopPhotoUrl +
        ", fdSmallPhotoUrl=" + fdSmallPhotoUrl +
        ", fdJobDuty=" + fdJobDuty +
        ", fdAddressPost=" + fdAddressPost +
        ", fdIdcardType=" + fdIdcardType +
        ", fdIdcard=" + fdIdcard +
        ", fdWechatSn=" + fdWechatSn +
        ", fdIfWechatShow=" + fdIfWechatShow +
