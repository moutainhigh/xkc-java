...
public class WebSSOConfig extends WebMvcConfigurerAdapter {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		registry.addInterceptor(applInterceptor()).addPathPatterns("/app/**").addPathPatterns("/H5/**").excludePathPatterns("/app/login/**","/app/system/mSystemAppVersion_Select","/app/system/mVerificationCode_Select","/app/login/mChannelRegistJZ_Insert",
				"/app/system/SystemAD_Select","/app/user/mUserForgetPwd_Update","/app/partReceive/mCustomerFJSearch_Select","/H5/mVerificationCode_Select","/H5/mLoginTK_SelectN","/H5/#/teamMemberRegister","/H5/mBrokerLoginForgetPwd_Update","/H5/getRqCode",
