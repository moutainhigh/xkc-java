 ...
 */
@Service
public class BSalesgroupmemberServiceImpl extends ServiceImpl<BSalesgroupmemberMapper, BSalesgroupmember>
		implements IBSalesgroupmemberService {
			...
			if (StringUtil.isNotNull(RoleID)) {
				...
				if (RoleID.equals("48FC928F-6EB5-4735-BF2B-29B1F591A582"))// 自渠人员
				{
					whereOne = " and RoleId in ('48FC928F-6EB5-4735-BF2B-29B1F591A582'," + // 自有渠道团队人员
							...
							"'WSD12580-003A-6505-B211-C2C2C2C2C2C2'," + // 自有渠道团队负责人_2.0
	...
	public Result SalesGroupMembers_Insert(Map<String, Object> map) {
		...
		if (StringUtil.isNull(ReceptionGroupID)) {
			...
			if (Integer.valueOf(Nature) == 3 || Integer.valueOf(Nature) == 4 || Integer.valueOf(Nature) == 5
					|| Integer.valueOf(Nature) == 6 || Integer.valueOf(Nature) == 7) {
		...
		if (StringUtil.isNotNull(RoleID) && RoleID.equals("8100EAF4-FBCE-408B-A51D-B7247A3ADB19")) // 销支
		{
			...
			for (int i = 0; i < idsStr.length; i++) {
				...
				SalesGroupMemberExistProjectVo salesGroupMemberExistProjectVo = bSaleGroupMemberMapper
						.SalesGroupMemberExistProject_Select(map);
				if (salesGroupMemberExistProjectVo != null) {
					return Result.errormsg(9527, "操作失败，" + salesGroupMemberExistProjectVo.getUserName() + "已在其他项目“"
							+ salesGroupMemberExistProjectVo.getProjectName() + "”的销管岗位");
				}
			}
		}
		// 添加人员
		if (StringUtil.isNotNull(Ids)) {
			...
			for (int i = 0; i < idStrs.length; i++) {
				...
				if (chanelUserCount == 0 && (RoleID.equals("B0BF5636-94AD-4814-BB67-9C1873566F29") || RoleID.equals("WSD12580-003A-6505-B211-C2C2C2C2C2C2")
						|| RoleID.equals("48FC928F-6EB5-4735-BF2B-29B1F591A582"))) {
					map.put("MemberID", idStrs[i]);
					map.put("UserID", UserID);
					bChanneluserMapper.insertBChannelUser(map);
				} else if (chanelUserCount > 0 && (RoleID.equals("B0BF5636-94AD-4814-BB67-9C1873566F29") || RoleID.equals("WSD12580-003A-6505-B211-C2C2C2C2C2C2")
						|| RoleID.equals("48FC928F-6EB5-4735-BF2B-29B1F591A582"))) {
				...
				// 自有渠道 团队负责人 团队人员
				if (RoleID.equals("B0BF5636-94AD-4814-BB67-9C1873566F29")  || RoleID.equals("WSD12580-003A-6505-B211-C2C2C2C2C2C2")
						|| RoleID.equals("48FC928F-6EB5-4735-BF2B-29B1F591A582")) {
				...
				} else if (RoleID.equals("3BC23001-BC31-4594-8463-C7DA89C0FB36")
						|| RoleID.equals("0269F35E-B32D-4D12-8496-4E6E4CE597B7")) {
					// 案场销售(顾问) 团队负责人 团队人员
					QueryWrapper<BQuituser> quitWrapper = new QueryWrapper<BQuituser>();
					quitWrapper.eq("IsDel", 0);
					quitWrapper.eq("Status", 1);
		...
		if (StringUtil.isNotNull(RemoveIds)) {
			...
			for (int i = 0; i < removeIdStrs.length; i++) {
				...
				if (channeluser != null && (roleId.equals("B0BF5636-94AD-4814-BB67-9C1873566F29") || roleId.equals("WSD12580-003A-6505-B211-C2C2C2C2C2C2")
						|| roleId.equals("48FC928F-6EB5-4735-BF2B-29B1F591A582"))) {
				...
				if (roleId.equals("B0BF5636-94AD-4814-BB67-9C1873566F29") || roleId.equals("WSD12580-003A-6505-B211-C2C2C2C2C2C2")
						|| roleId.equals("48FC928F-6EB5-4735-BF2B-29B1F591A582")) {
					// int customerCount =
					// clueListSelectMapper.getCustomerCount(projectId,memberId);
					// if(customerCount>0){
	...
	@Override
	@Transactional(rollbackFor = Exception.class)
	public Result setZqLeader(Map<String, Object> map) {
		String PersonId = (String) map.get("PersonId");// 负责人ID
		String ReceptionGroupID = (String) map.get("ReceptionGroupID");// 团队ID
		if (StringUtil.isNull(ReceptionGroupID))
			return Result.errormsg(9527, "无效的自渠团队ID");

		QueryWrapper<BSalesgroup> queryWrapper = new QueryWrapper<BSalesgroup>();
		queryWrapper.eq("ID", ReceptionGroupID);
		BSalesgroup bSalesgroup = (BSalesgroup) bSalesgroupMapper.selectOne(queryWrapper);
		if (bSalesgroup == null || bSalesgroup.getNature() == null || 3 > bSalesgroup.getNature()
				|| bSalesgroup.getNature() > 7)
			return Result.errormsg(9527, "无效的自渠团队ID");

		String RoleID = "48FC928F-6EB5-4735-BF2B-29B1F591A582";
		String RoleName = "自有渠道人员";
		String leaderRoleId = "WSD12580-003A-6505-B211-C2C2C2C2C2C2"; // 自渠经理
		String leaderRoleName = "自有渠道团队负责人_2.0";
		
		BSalesgroupmember temp2 = new BSalesgroupmember();
		UpdateWrapper<BSalesgroupmember> updateWrapper2 = new UpdateWrapper<>();
		temp2.setRoleID(1 == (Integer) map.get("IsLeadingOfficial") ? RoleID : leaderRoleId);
		temp2.setRoleName(1 == (Integer) map.get("IsLeadingOfficial") ? RoleName : leaderRoleName);
		updateWrapper2.eq("ID", PersonId);
		this.update(temp2, updateWrapper2);
