...
//            result.setErrmsg("注册失败，请联系管理员开通");
            ...
            if (oldOwner > 0 && !channelTypeID.equals("EB4AD331-F4AD-46D6-889A-D45575ECEE66")) {
                result.setErrcode(1);
                result.setErrmsg("注册失败，您只能注册老业主");
                return result;
            }
            ...
            if (staff > 0 && !channelTypeID.equals("725FA5F6-EC92-4DC6-8D47-A8E74B7829AD")) {
                result.setErrcode(1);
                result.setErrmsg("注册失败，您只能注册泰禾员工");
                return result;
            }
     ...
     */
    @Override
    public Map<String, Object> mChannelCheckClockTotal_Select(Map<String, Object> map) {
